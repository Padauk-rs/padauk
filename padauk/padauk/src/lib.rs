...
pub mod prelude {
    ...
    pub use crate::ui::navigation_drawer::{
    ...
    pub use crate::ui::widget::{
        ...
        nav_destination, nav_drawer_destination, navigation_bar, navigation_drawer,
...
pub const FRAMEWORK_AAR: &[u8] = include_bytes!("../assets/android/padauk-android.zip");
